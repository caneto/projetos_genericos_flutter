...
import 'package:weather/src/models/model.dart';
...
class Today extends StatefulWidget {
  ...
  const Today({super.key, required this.location});
...
class _TodayState extends State<Today> {
 ...
 void startApp() async {
   await weatherData.getData(widget.location);
   setState(() {
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          const MyRow(title: 'Dew points', text: '19c°'),
          ...
          const MyRow(title: 'Length of day', text: '12h 40m'),
        ],
      ),
    );
  }
