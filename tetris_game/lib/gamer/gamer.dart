...
class GameControl extends State<Game> with RouteAware {
  ...
  /// Misture com [_data] no método [build] para formar uma nova matriz.
  /// A largura e a altura da matriz [_mask] são as mesmas de [_data].
  /// Para qualquer _mask[x,y]:
  /// Se for 0, não terá efeito em [_data].
  /// Se -1, a linha não é mostrada em [_data].
  /// Se o valor for 1, a linha em [_data] é destacada.
